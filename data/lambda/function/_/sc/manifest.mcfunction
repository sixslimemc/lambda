...
data modify storage slimecore:in manifest.pack.url set value "https://github.com/sixslimemc/lambda/releases/download/v0.1.0/sixslime.lambda.0.1.0.zip"

data modify storage slimecore:in manifest.pack.display.name set value "Lambda"
data modify storage slimecore:in manifest.pack.display.summary set value "Structured, macro-based, lambdas."
...
data modify storage slimecore:in manifest.pack.display.links.info set value "https://github.com/sixslimemc/lambda"
data modify storage slimecore:in manifest.pack.display.links.versions set value "https://github.com/sixslimemc/lambda/releases"
